...
/**
 * 
 * This class contains the result of a single test case. This contains if the
 * test passed or failed, and also has details about the results of the
...
public class TestResult {
	...
	/**
	 * This is the TestResult constructor. It sets the passing boolean to true or
	 * false based on what is given, and also contains a string that has the results
	 * of the test.
	 * 
	 * @param passing       boolean representing whether the test case was passing
	 *                      or failing
	 ...
	 * 
	 * @return "PASS: " + actualResults if passing == true "FAIL: " + actualResults
	 *         if passing == false
	 */
