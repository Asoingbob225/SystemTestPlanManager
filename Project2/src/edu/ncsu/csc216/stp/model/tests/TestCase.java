 ...
 * the testDescription, and the expectedResults. It also belongs to a certain TestPlan.
 * @author yujim
 *
 */
public class TestCase {
	...
	/**
	 * This is the constuctor for TestCases. Sets all of these parameters to what is given. The testPlan
	 * is set to null.
	 ...
	 * is passing.
	 * @return true if the last testResult in the log is passing and false otherwise.
	 */
	...
	/**
	 * This returns the status of the tetCase
